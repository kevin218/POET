...
def apphot(image,  ctr,  photap,  skyin,    skyout,
  ...
  skyann  = di.disk(iskyout, ictr, isz) - di.disk(iskyin,  ictr, isz)
  ...
  ret[nskyideal] = np.sum( di.disk(iskyout, ctrsky, szsky) -
