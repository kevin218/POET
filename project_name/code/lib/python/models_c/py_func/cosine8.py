...
def cosine8(rampparams, t, etc = []):
  ...
  2014-05-14	Kevin Stevenson, UChicago
   ...
   return ne.evaluate('a1*cos(2*pi*(t-t1)/p1) + a2*cos(2*pi*(t-t2)/p2) + a3*cos(2*pi*(t-t3)/p3) + a4*cos(2*pi*(t-t4)/p4) + a5*cos(2*pi*(t-t5)/p5) + a6*cos(2*pi*(t-t6)/p6) + a7*cos(2*pi*(t-t7)/p7) + a8*cos(2*pi*(t-t8)/p8) + c')
