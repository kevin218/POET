...
def init_models():
    models = [#ECLIPSES / TRANSITS
	    ...
	    ["mandelorbit",  "e\tomega\ti\tperiod\trplanet\trstar\tmstar\tecldepth\tflux\n", np.zeros((4, 9))],
            ...
            ["linramp_paor", "linra0    \tlina1     \tlina2     \tlina3     \tlina4     \tlinb0     \tlinb1     \tlinb2     \tlinb3     \tlinb4     \tlint0     \tlint1     \tlint2     \tlint3     \tlint4\n", np.zeros((4, 15))],
            ...
            ["sincos3",      "c1a       \tc1o       \tc2a       \tc2o       \ts1a       \ts1o       \ts2a       \ts2o       \tp         \tc         \tmidpt     \tt14       \tt12\n", np.zeros((4,13))],
            ...
            ["lambertian_phase",         "t0        \tper       \tcosi      \tlo0       \tampl      \tc         \tmidpt     \tt14       \tt12\n", np.zeros((4,9))],
            ["lambertian_ecc",         "t0        \tper       \tcosi      \tlo0       \tampl      \tc         \tmidpt     \tt14       \tt12\n", np.zeros((4,9))],
            ...
            ["cubicgw", "x1\tx2\tx3\ty1\ty2\ty3\tc\ts0\n", np.zeros((4, 8))],
            ["cubicgw2", "x1\tx2\tx3\ty1\ty2\ty3\tc\ts0\n", np.zeros((4, 8))],
            ["cubicgw3", "x1\tx2\tx3\ty1\ty2\ty3\tc\ts0\n", np.zeros((4, 8))],
